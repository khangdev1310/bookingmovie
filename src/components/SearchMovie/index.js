...
import {getlichchieuphimtheohethongRap} from '../../redux/action/quanlyrapActions';
...
const SearchMovie = () => {
  ...
  const movieList = useSelector((state) => state.coursesReducer.courses1);
  const searchMovieFind = useSelector(
    (state) => state.lichchieuphimhethongrapReducer.searchMovieFind
  );
